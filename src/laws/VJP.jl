...
It is for internal use only and it isn't exposed to the user.
"""
function emptyPrepVJP(cache, vjpPrep, simulation, glacier_idx, t, θ)
    throw("This VJP preparation has not been defined.")
end
function emptyPrepVJPWithInputs(cache, vjpPrep, inputs, θ)
    throw("This VJP preparation has not been defined.")
end
...
"""
function prepare_vjp_law(simulation, law::AbstractLaw, law_cache, θ, glacier_idx)
    throw("This prepare function has not been defined.")
end
...
function apply_all_non_callback_laws!(
        model::AbstractModel, cache, simulation, glacier_idx, t, θ)
    throw("This function should not be called. Implement apply_all_non_callback_laws! for your own model.")
end
...
function precompute_all_VJPs_laws!(
        model::AbstractModel, cache, simulation, glacier_idx, t, θ)
    throw("This function should not be called. Implement precompute_all_VJPs_laws! for your own model.")
end
...
function apply_all_callback_laws!(
        model::AbstractModel, cache, simulation, glacier_idx, t, θ)
    throw("This function should not be called. Implement apply_all_callback_laws! for your own model.")
end
